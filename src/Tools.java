...
public class Tools
{
	...
	private static final Image METAL = Tools.createImage("background.jpg");
	private static final double CORNER_RADIUS = 20.0;
	private static final InnerShadow BEVEL_SHADOW = new InnerShadow(10.0, Color.BLACK);
	 ...
	 */
	public static Obstacle createBase(double height, double width, double xLoc, double yLoc, double widthRatio, double heightRatio, double smallestRatio,
			Effect eff)
	{
	 ...
	 */
	public static Unit createCorporal(int team, double height, double width, double angle, double xLoc, double yLoc, double widthRatio, double heightRatio,
	 ...
	 */
	public static Ellipse createEllipse(double centerX, double centerY, double radiusX, double radiusY, double widthRatio, double heightRatio,
			double smallestRatio, Color col, Effect eff)
	{
		return null;
	}
	 ...
	 */
	public static ImageView createImageView(Image img, double height, double width, double xLoc, double yLoc, double widthRatio, double heightRatio,
			double smallestRatio, Effect eff)
	{
	...
	public static MoneyBag createMoneyBag(int value, double xLoc, double yLoc, double widthRatio, double heightRatio, double smallestRatio, Effect eff)
	{
		...
		bag.setImage(MONEY);
		bag = (MoneyBag) setImgView(bag, MONEY_SIZE * value / MAX_MONEY_BAG, MONEY_SIZE * value
				/ MAX_MONEY_BAG, xLoc, yLoc, widthRatio, heightRatio, smallestRatio, eff);

		bag.updateCollShape(MONEY_SIZE * value / MAX_MONEY_BAG, MONEY_SIZE * value
				/ MAX_MONEY_BAG, DEFAULT_ANGLE, xLoc, yLoc, widthRatio, heightRatio, smallestRatio);
	 ...
	 */
	public static Unit createPrivate(int team, double height, double width, double angle, double xLoc, double yLoc, double widthRatio, double heightRatio,
			double smallestRatio, Effect eff)
	{
	 ...
	 */
	public static Projectile createProjectile(double damage, double height, double width, double angle, double startXLoc, double startYLoc, double widthRatio,
	 ...
	 */
	public static Unit createScout(int team, double height, double width, double angle, double xLoc, double yLoc, double widthRatio, double heightRatio,
			double smallestRatio, Effect eff)
	{
	 ...
	 */
	public static Unit createSergeant(int team, double height, double width, double angle, double xLoc, double yLoc, double widthRatio, double heightRatio,
			double smallestRatio, Effect eff)
	{
	 ...
	 */
	public static Unit createSniper(int team, double height, double width, double angle, double xLoc, double yLoc, double widthRatio, double heightRatio,
			double smallestRatio, Effect eff)
	{
	 ...
	 */
	public static Obstacle createSolid(Image img, double height, double width, double xLoc, double yLoc, double widthRatio, double heightRatio,
			double smallestRatio, Effect eff)
	{
	 ...
	 */
	public static Unit createTank(int team, double height, double width, double angle, double xLoc, double yLoc, double widthRatio, double heightRatio,
			double smallestRatio, Effect eff)
	{
	 ...
	 */
	public static Text createText(double xLoc, double yLoc, double widthRatio, double heightRatio, String content, Color col, Effect eff, Font f)
	{
	 ...
	 */
	public static TextField createTextField(double width, double height, double xLoc, double yLoc, double widthRatio, double heightRatio, String content,
			Effect eff)
	{
	 ...
	 */
	public static ImageView setImgView(ImageView imgV, double height, double width, double xLoc, double yLoc, double widthRatio, double heightRatio,
			double smallestRatio, Effect eff)
	{
		imgV.setEffect(eff);
	 ...
	 */
	public static void setUpFrame(Pane frame)
	{
		Rectangle back = new Rectangle();
		back.widthProperty().bind(frame.widthProperty());
		back.heightProperty().bind(frame.heightProperty());
		back.setFill(new ImagePattern(METAL, 0, 0, 1, 1, true));
		back.setArcHeight(CORNER_RADIUS);
		back.setArcWidth(CORNER_RADIUS);
		back.setEffect(BEVEL_SHADOW);
