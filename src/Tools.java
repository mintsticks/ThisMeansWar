...
public class Tools {
	...
	public static final InnerShadow LARGE_SHADE = new InnerShadow(5.0,
			Color.BLACK);
	public static final InnerShadow MEDIUM_SHADE = new InnerShadow(3.0,
			Color.BLACK);
	public static final InnerShadow SMALL_SHADE = new InnerShadow(2.0,
			Color.BLACK);
	public static final DropShadow LARGE_OUT_SHADE = new DropShadow(5.0,
			Color.BLACK);
	public static final DropShadow MEDIUM_OUT_SHADE = new DropShadow(3.0,
			Color.BLACK);
	public static final DropShadow SMALL_OUT_SHADE = new DropShadow(2.0,
			Color.BLACK);

	public static final DropShadow LARGE_WHITE_OUT = new DropShadow(5.0,
			Color.WHITE);
	public static final DropShadow RED_OUT_SHADE = new DropShadow(5.0,
			TEAM_COLORS[0]);
	public static final DropShadow CYAN_OUT_SHADE = new DropShadow(5.0,
			TEAM_COLORS[1]);
	public static final DropShadow GREEN_OUT_SHADE = new DropShadow(5.0,
			TEAM_COLORS[2]);
	public static final DropShadow PINK_OUT_SHADE = new DropShadow(5.0,
			TEAM_COLORS[3]);
	...
	// Icons for the units
	public static final Image PRIVATE_ICON = Tools
			.createImage("Icons/PrivateIcon.png");
	public static final Image CORP_ICON = Tools
			.createImage("Icons/CorpIcon.png");
	public static final Image SERG_ICON = Tools
			.createImage("Icons/SergIcon.png");
	public static final Image TANK_ICON = Tools
			.createImage("Icons/TankIcon.png");
	public static final Image SNIPER_ICON = Tools
			.createImage("Icons/SniperIcon.png");
	public static final Image SCOUT_ICON = Tools
			.createImage("Icons/ScoutIcon.png");
	...
	/**
	 * Creates an obstacle, which is a base where the players units spawn It is
	 * displayed on the screen in a specified location with a given size and
	 * effect
	 ...
	 */
	public static Obstacle createBase(double height, double width, double xLoc,
			double yLoc, double widthRatio, double heightRatio,
	...
	/**
	 * Generates a Unit with the statistics of a corporal. It is displayed on
	 * the screen in a specified location with a given size and effect
	 ...
	 */
	public static Unit createCorporal(int team, double height, double width,
			double angle, double xLoc, double yLoc, double widthRatio,
			double heightRatio, double smallestRatio, Effect eff) {
		Unit corp = new Unit(team, CORP_HEALTH, CORP_ATT_RANGE, CORP_DMG,
				CORP_MOVE_RANGE, CORP_COST, CORP_ICON, CORP, CORP_TEXT);
		corp = (Unit) setImgView(corp, height, width, xLoc, yLoc, widthRatio,
				heightRatio, smallestRatio, eff);
		corp.updateCollShape(height, width, angle, xLoc, yLoc, widthRatio,
	...
	/**
	 * Generates an ellipse on the screen with a given x and y radius, location,
	 * color, and effect
	 ...
	 */
	public static Ellipse createEllipse(double centerX, double centerY,
			double radiusX, double radiusY, double widthRatio,
	 ...
	 * @param weight weight of the font; if null, creates font with default
	 * weight (regular)
	 * @param size size of the font
	 * @param smallestRatio ratio to resize font to the dimensions of the screen
	 * @return font created with input preferences
	 */
	public static Font createFont(String font, FontWeight weight, double size,
	...
	/**
	 * Loads an image and returns it based on a given string Uses ClassLoader to
	 * load the class and get its resources Site used to learn how to load
	 * images:
	 * http://stackoverflow.com/questions/14089146/file-loading-by-getclass-
	 * getresource
	 * @param name name of the image file, ex: "image.png"
	 * @return image that is at the given location
	 */
	public static Image createImage(String name) {
		return new Image(ClassLoader.getSystemClassLoader()
				.getResourceAsStream("res/" + name));
	}

	/**
	 * Generates an image view on the screen in a given location with a given
	 * image, size, and effect
	 ...
	 */
	public static ImageView createImageView(Image img, double height,
			double width, double xLoc, double yLoc, double widthRatio,
			double heightRatio, double smallestRatio, Effect eff) {
	...
	/**
	 * Creates a money bag with size baased on money value It is displayed on
	 * the screen in a specified location with a given size and effect
	 ...
	 */
	public static MoneyBag createMoneyBag(int value, double xLoc, double yLoc,
			double widthRatio, double heightRatio, double smallestRatio,
			Effect eff) {
		MoneyBag bag = new MoneyBag(value);
		bag.setImage(MONEY);
		bag = (MoneyBag) setImgView(bag, MONEY_SIZE * value / MAX_MONEY_BAG,
				MONEY_SIZE * value / MAX_MONEY_BAG, xLoc, yLoc, widthRatio,
				heightRatio, smallestRatio, eff);

		bag.updateCollShape(MONEY_SIZE * value / MAX_MONEY_BAG,
				MONEY_SIZE * value / MAX_MONEY_BAG, DEFAULT_ANGLE, xLoc, yLoc,
				widthRatio, heightRatio, smallestRatio);
	...
	/**
	 * Generates a Unit with the statistics of a private. It is displayed on the
	 * screen in a specified location with a given size and effect
	 ...
	 */
	public static Unit createPrivate(int team, double height, double width,
			double angle, double xLoc, double yLoc, double widthRatio,
			double heightRatio, double smallestRatio, Effect eff) {
		Unit priv = new Unit(team, PRIV_HEALTH, PRIV_ATT_RANGE, PRIV_DMG,
				PRIV_MOVE_RANGE, PRIV_COST, PRIVATE_ICON, PRIVATE,
				PRIVATE_TEXT);
		priv = (Unit) setImgView(priv, height, width, xLoc, yLoc, widthRatio,
				heightRatio, smallestRatio, eff);
		priv.updateCollShape(height, width, angle, xLoc, yLoc, widthRatio,
				heightRatio, smallestRatio);
		return priv;
	}

	/**
	 * Creates a projectile that has a certain amount of damage. Displays on the
	 * field with a given angle, size, location, and effect
	 * @param damage damage that the projectile will inflict on a unit that it
	 * hits
	 ...
	 */
	public static Projectile createProjectile(double damage, double height,
			double width, double angle, double startXLoc, double startYLoc,
			double widthRatio, double heightRatio, double smallestRatio,
			Effect eff) {
		Projectile bullet = new Projectile(damage);
		bullet.setImage(createImage("Bullet.png"));
		bullet = (Projectile) setImgView(bullet, height, width, startXLoc,
				startYLoc, widthRatio, heightRatio, smallestRatio, eff);

		bullet.setRotate(angle);
		bullet.updateCollShape(height, widthRatio, angle, startXLoc, startYLoc,
				widthRatio, heightRatio, smallestRatio);
	...
	/**
	 * Generates a rounded rectangle on the screen with a given size, arc size,
	 * effect, color, and location.
	 ...
	 */
	public static Rectangle createRoundedRectangle(double width, double height,
			double arcW, double arcH, double xLoc, double yLoc,
			double widthRatio, double heightRatio, double smallestRatio,
			Color col, Effect eff) {
		Rectangle rect = new Rectangle(width * widthRatio,
				height * heightRatio);
	...
	/**
	 * Generates a Unit with the statistics of a scout. It is displayed on the
	 * screen in a specified location with a given size and effect
	 * @param team team that the unit belongs to
	 * @param height desired height of image view
	 * @param width desired width of image view
	 ...
	 */
	public static Unit createScout(int team, double height, double width,
			double angle, double xLoc, double yLoc, double widthRatio,
			double heightRatio, double smallestRatio, Effect eff) {
		Unit scout = new Unit(team, SCOUT_HEALTH, SCOUT_ATT_RANGE, SCOUT_DMG,
				SCOUT_MOVE_RANGE, SCOUT_COST, SCOUT_ICON, SCOUT, SCOUT_TEXT);
		scout = (Unit) setImgView(scout, height, width, xLoc, yLoc, widthRatio,
				heightRatio, smallestRatio, eff);
		scout.updateCollShape(height, width, angle, xLoc, yLoc, widthRatio,
				heightRatio, smallestRatio);
	...
	/**
	 * Generates a Unit with the statistics of a sergeant. It is displayed on
	 * the screen in a specified location with a given size and effect
	 * @param team team that the unit belongs to
	 * @param height desired height of image view
	 * @param width desired width of image view
	 ...
	 */
	public static Unit createSergeant(int team, double height, double width,
			double angle, double xLoc, double yLoc, double widthRatio,
			double heightRatio, double smallestRatio, Effect eff) {
		Unit serg = new Unit(team, SERG_HEALTH, SERG_ATT_RANGE, SERG_DMG,
				SERG_MOVE_RANGE, SERG_COST, SERG_ICON, SERG, SERG_TEXT);
		serg = (Unit) setImgView(serg, height, width, xLoc, yLoc, widthRatio,
				heightRatio, smallestRatio, eff);
		serg.updateCollShape(height, width, angle, xLoc, yLoc, widthRatio,
				heightRatio, smallestRatio);
	...
	/**
	 * Generates a Unit with the statistics of a sniper. It is displayed on the
	 * screen in a specified location with a given size and effect
	 * @param team team that the unit belongs to
	 * @param height desired height of image view
	 * @param width desired width of image view
	 ...
	 */
	public static Unit createSniper(int team, double height, double width,
			double angle, double xLoc, double yLoc, double widthRatio,
			double heightRatio, double smallestRatio, Effect eff) {
		Unit sniper = new Unit(team, SNIP_HEALTH, SNIP_ATT_RANGE, SNIP_DMG,
				SNIP_MOVE_RANGE, SNIP_COST, SNIPER_ICON, SNIPER, SNIPER_TEXT);
		sniper = (Unit) setImgView(sniper, height, width, xLoc, yLoc,
				widthRatio, heightRatio, smallestRatio, eff);
		sniper.updateCollShape(height, width, angle, xLoc, yLoc, widthRatio,
				heightRatio, smallestRatio);
	...
	/**
	 * Creates a solid object, which is a object which players cannot pass
	 * through It is displayed on the screen in a specified location with a
	 * given size and effect
	 ...
	 */
	public static Obstacle createSolid(Image img, double height, double width,
			double xLoc, double yLoc, double widthRatio, double heightRatio,
			double smallestRatio, Effect eff) {
		Obstacle solid = new Obstacle(false);
		solid.setImage(img);
		solid = (Obstacle) setImgView(solid, height, width, xLoc, yLoc,
				widthRatio, heightRatio, smallestRatio, eff);
		solid.updateCollShape(height, widthRatio, DEFAULT_ANGLE, xLoc, yLoc,
				widthRatio, heightRatio, smallestRatio);
		return solid;
	}

	/**
	 * Generates a Unit with the statistics of a tank. It is displayed on the
	 * screen in a specified location with a given size and effect
	 * @param team team that the unit belongs to
	 * @param height desired height of image view
	 * @param angle desired angle of image view
	 ...
	 */
	public static Unit createTank(int team, double height, double width,
			double angle, double xLoc, double yLoc, double widthRatio,
			double heightRatio, double smallestRatio, Effect eff) {
		Unit tank = new Unit(team, TANK_HEALTH, TANK_ATT_RANGE, TANK_DMG,
				TANK_MOVE_RANGE, TANK_COST, TANK_ICON, TANK, TANK_TEXT);
		tank = (Unit) setImgView(tank, height, width, xLoc, yLoc, widthRatio,
				heightRatio, smallestRatio, eff);
		tank.updateCollShape(height, width, angle, xLoc, yLoc, widthRatio,
				heightRatio, smallestRatio);
	...
	/**
	 * Generates text on the screen in a given location with a given font and
	 * message
	 * @param xLoc the x-coordinate of the text
	 * @param yLoc the y-coordinate of the text
	 * @param widthRatio the ratio of the user's desired width resolution to the
	 ...
	 */
	public static Text createText(double xLoc, double yLoc, double widthRatio,
			double heightRatio, String content, Color col, Effect eff, Font f) {
	...
	/**
	 * Generates a text field on the screen with a given size, starting string,
	 * effect, and location.
	...
	/**
	 * Sets the characteristics of given image view to the values given,
	 * including its height, width, x location, y location, and effect.
	 ...
	 */
	public static ImageView setImgView(ImageView imgV, double height,
			double width, double xLoc, double yLoc, double widthRatio,
			double heightRatio, double smallestRatio, Effect eff) {
		imgV.setEffect(eff);
