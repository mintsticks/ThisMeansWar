...
public class Unit extends UIElement {
	...
	private String type;
	private int team;
	// Stores whether the unit has attacked or moved this turn. If both are
	// true, then the unit cannot be selected anymore
	private boolean attacked;
	private boolean moved;

	/**
	 * Creates a unit with the given statistics of health, attack/movement
	 * ranges, damage, cost, and appearance
	 * @param team number team the unit belongs to
	 * @param health the health value that the unit has
	 * @param attackRange the distance that a bullet fired by this unit can
	 * travel
	 * @param damage damage that a bullet fired by this unit will do to an enemy
	 * unit
	 * @param moveRange the distance that this unit can travel in one turn
	 * @param cost the amount of money that it takes for a Player to purchase
	 * this unit
